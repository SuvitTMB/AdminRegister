...
function loadData() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      //   ShowTrip = "-";
      //}
      dataSet = [doc.data().SendUnderRH, doc.data().EmpID, doc.data().EmpName,  doc.data().ClickView, doc.data().ClickLike ,doc.data().ClickMemo ,"<div class='btn-t1 btn-add' id="+i+">คลิก</div>", doc.id, i];
